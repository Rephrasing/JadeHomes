...
@GalaxyCommandParams(name = "jadedeletehome", aliases = "deletehome", description = "allows home deletion")
@GalaxyCommandPermissions(source = GalaxyCommandSource.IN_GAME)
public class JadeDeleteHome extends AbstractGalaxyCommand {

    private final HashMap<UUID, Long> cooldowns = new HashMap<>();

    public JadeDeleteHome() throws GalaxyInitializationException {
        super();
    }
    ...
    protected Component execute(@NotNull CommandSender sender, @Nullable Player playerSender, @NotNull String[] args) {
        ...
        JadeResponse response = JadeCacheHandler.getInstance().deleteJadeHome(playerSender, args[0]);
        ...
        return JadeHomesPlugin.parseMessage(String.format("<gray>You have successfully deleted your JadeHome with the name </gray><yellow>%s</yellow>", args[0]));
    }
